 ...
 $(document).ready(function(){  
    //python generated data for carousel begin
		let img_files = ['projects_data\\blood_vessels\\crossP.PNG', 'projects_data\\blood_vessels\\crossV.PNG', 'projects_data\\blood_vessels\\handP.PNG', 'projects_data\\blood_vessels\\handV.PNG', 'projects_data\\blood_vessels\\squareP_MAIN.PNG', 'projects_data\\blood_vessels\\squareV.PNG', 'projects_data\\blood_vessels\\zigzagP.PNG', 'projects_data\\blood_vessels\\zigzagV.PNG', 'projects_data\\heart_rate_simulator\\1.png', 'projects_data\\heart_rate_simulator\\2.png', 'projects_data\\heart_rate_simulator\\3.png', 'projects_data\\heart_rate_simulator\\4.png', 'projects_data\\heart_rate_simulator\\5.png', 'projects_data\\heart_rate_simulator\\circuit.jpg', 'projects_data\\heart_rate_simulator\\MAIN.png']; 
...
$(document).ready(function(){  
    //python generated data for projects grid begin
		let all_imgs = ['projects_data\\blood_vessels\\squareP_MAIN.PNG', 'projects_data\\heart_rate_simulator\\MAIN.png'];
		let all_titles = ['Computer modeling of blood vessel tree growth', 'Heart rate simulator'];
